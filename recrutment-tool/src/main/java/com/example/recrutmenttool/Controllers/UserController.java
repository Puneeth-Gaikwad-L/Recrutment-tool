...
public class UserController {
    ...
    public ResponseEntity updateFields(@PathVariable String username,UserRequestDto userRequestDto){
...
//    @GetMapping("/getAllClients/{username}")
//    public ResponseEntity getClients(@PathVariable String username){
//        List<Client> clientList= userService.getClients(username);
